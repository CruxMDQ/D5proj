...
public class BaseStatsFragment extends Fragment {
    ...
    private void generateRolls() {
        ...
        editor.putString("rand1", String.valueOf(rollDice(4, 6, 1)));
        editor.putString("rand2", String.valueOf(rollDice(4, 6, 1)));
        editor.putString("rand3", String.valueOf(rollDice(4, 6, 1)));
        editor.putString("rand4", String.valueOf(rollDice(4, 6, 1)));
        editor.putString("rand5", String.valueOf(rollDice(4, 6, 1)));
        editor.putString("rand6", String.valueOf(rollDice(4, 6, 1)));
    ...
    private int rollDice(int dice, int size, int discard) {
        int total = 0;

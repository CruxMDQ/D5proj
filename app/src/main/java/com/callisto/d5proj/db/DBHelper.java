...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(DBCreatureTypes.DEFINITION);
        db.execSQL(DBCreatureTypes.INDEX);
        db.execSQL(DBTraits.DEFINITION);
        db.execSQL(DBTraits.INDEX);
        db.execSQL(D_TYPES_TRAITS);
    }
    ...
    private static final String DB_NAME = "d35proj.sqlite";
